...
export default function CardsSteps() {
    return (
        <div className="">
            <div class="sc-g6c3md-1 sc-1ehwxu-0 kJGgHi gGwbWp">
                <div class="sc-1ehwxu-8 jDYudt"></div>
                ...
                <div class="sc-1ehwxu-2 hHnUWF">
                    <div>
                        <video playsinline="" poster="https://web-images.credcdn.in/v2/_next/assets/images/cards/desktop/interactions/swipe-fallback.jpg?tr=orig" class="sc-1ehwxu-3 edROEC" loop="">
                        ...
                        <div class="sc-1ehwxu-5 hpTdVv">
                            ...
                            <div class="sc-1ehwxu-7 lbxDUD">
                                <p class="sc-g6c3md-9 kkVKoh">
                                    SWIPE LEFT <span class="sc-g6c3md-10 buBswu">on any card to manage payment history, card offers, and more.</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="sc-1ehwxu-5 hpTdVv">
                            ...
                            <div class="sc-1ehwxu-7 lbxDUD">
                                <p class="sc-g6c3md-9 kkVKoh">
                                    PRESS AND HOLD <span class="sc-g6c3md-10 buBswu">a card to view balances, usage limits, recent activity and other key details.</span>
                                </p>
                            </div>
                        </div>
                    </div>
